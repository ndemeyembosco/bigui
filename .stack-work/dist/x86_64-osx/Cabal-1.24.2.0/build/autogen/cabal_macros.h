...
/* package Bi-directional-diagrams-gui-0.1.0.0 */
#define VERSION_Bi_directional_diagrams_gui "0.1.0.0"
#define MIN_VERSION_Bi_directional_diagrams_gui(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package threepenny-gui-0.7.0.2 */
#define VERSION_threepenny_gui "0.7.0.2"
...
#define CURRENT_COMPONENT_ID "Bi-directional-diagrams-gui-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Bi-directional-diagrams-gui-0.1.0.0"
